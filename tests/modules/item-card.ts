...
export class ItemCard {
    ...
    async approve() {
        ...
        // promise whose rejection surfaces on a later step; on slower backends
        // (e.g. Postgres) the next navigation destroys the toast before it is
        // ever observed, making the test fail deterministically.
